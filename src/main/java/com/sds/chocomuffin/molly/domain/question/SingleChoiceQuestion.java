...
@Getter
@ToString
public class SingleChoiceQuestion implements Question, HasChoice, Opinion, EtcChoice, HasSkipLogics, HasChoiceLabel {
    ...
    @With private final String referenceId;
    @With private final String referenceNo;
    @With private final List<DisplayLogic> displayLogics;

    @With private final List<SkipLogic> skipLogics;
    ...
    @With private final boolean hasOpinionInputOption;
    private final String opinionQuestionText;

    public SingleChoiceQuestion(QuestionBasic basic, ChoiceLabel choiceLabel, ImageSize imageSize, List<Choice> choices, boolean hasEtcChoice, boolean hasOpinionInputOption, String opinionQuestionText, List<SkipLogic> skipLogics) {
        this.id = basic.getId();
    ...
    public boolean equals(Question question) {
        if(!(question instanceof SingleChoiceQuestion)) return false;
    ...
    public QuestionView toQuestionView() {
        return questionViewBuilder(this)
                ...
                .choices(toFatChoice(this.getChoices(), this.getChoiceLabel()))
